...
class Student
{
	...
	public Student(String rolNo, String nam, String dpt, Subject... subs)
	{
		rollNo=rolNo;
		name=nam;
		department=dpt;
...
class SubjectStudentDetails1
{
	public static void main(String[] args)
	{
        ...
        Subject sub1 = new Subject("10PHY2019", "Physics", 100, 80);
        Subject sub2 = new Subject("10MTH2019", "Mathematics", 100, 90);
        Subject sub3 = new Subject("10CHEM2019", "Chemistry", 100, 85);
		
		// Creating a Student object with multiple Subjects
        Student stu = new Student("1KT16CV010", "Arbaz", "Civil", sub1, sub2, sub3);
		
		// Printing student details, including subjects
        System.out.println("Student Details:\n" + stu);
